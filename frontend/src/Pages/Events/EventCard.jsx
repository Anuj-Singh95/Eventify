...
// const EventCard = ({ event, onLoadingHandler, registeredEvents, onRegOrCancelReg, isPast }) => {
//   const [isRegistered, setIsRegistered] = useState(false);
//   const [viewMore, setViewMore] = useState(false);
//   const [registrationsCount, setRegistrationsCount] = useState(event.registrationsCount); // Track registrations count
...
//     const isRegisteredEvent = registeredEvents.some((registration) => registration.event_id === _id);
...
//     let response = await fetch("http://localhost:5000/api/v1/cancel-registration", {
//       method: "POST",
//       headers: {
//         token: token,
//         "Content-Type": "application/json",
...
//         {/* Display Image */}
//         {imageUrl && <img src={imageUrl} alt={eventName} className="w-full h-48 object-cover rounded-lg mb-4" />}

//         {/* Event Description and View More Toggle */}
//         <p className="text-gray-700 mb-2">
//           {viewMore ? description : `${description.slice(0, 100)}...`}
//         </p>
//         <button onClick={() => setViewMore(!viewMore)} className="text-blue-500 underline mb-2">
//           {viewMore ? "View Less" : "View More"}
//         </button>

//         {/* View More Modal for Event Details */}
//         {viewMore && <FullScreenModal event={event} onClose={() => setViewMore(false)} />}

//         <p className="text-gray-600 mb-1">Type: {eventType}</p>
//         <p className="text-gray-600 mb-1">Date: {new Date(date).toLocaleDateString()}</p>
//         <p className="text-gray-600 mb-1">Time: {startTime} - {endTime}</p>
//         <p className="text-gray-600 mb-1">Location: {location}</p>
//         <p className="text-gray-600 mb-1">Capacity: {capacity}</p>

//         {/* Display the number of registrations */}
//         <p className="text-gray-600 mb-1">Registrations: {registrationsCount}</p>
//       {
//         !isPast && (isRegistered ? (
//           <button
//             value={_id}
